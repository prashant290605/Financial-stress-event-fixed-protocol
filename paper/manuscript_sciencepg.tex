...
\usepackage{dsfont}
\usepackage{multirow}
% [hyphens] lets long URLs break at hyphens inside narrow columns; hyperref
% (loaded last, as it must be) makes every \url a real link that stays
% clickable across line breaks instead of relying on the PDF viewer's
% per-line text detection.
...
\begin{figure}[!tbp]
\centering
\includegraphics[width=0.75\textwidth]{confirmation_window_sensitivity.png}
...
\bibitem{11} Basel Committee on Banking Supervision. Supervisory Framework for the Use of `Backtesting' in Conjunction with the Internal Models Approach to Market Risk Capital Requirements. Bank for International Settlements; 1996. Available from: \url{https://www.bis.org/publ/bcbs22.htm}
...
\bibitem{14} Bussi{\`e}re, M., Fratzscher, M. Towards a new early warning system of financial crises. Journal of International Money and Finance. 2006, 25(6), 953-973.
...
\bibitem{28} International Monetary Fund. Global Financial Stability Report: Global Financial Markets Confront the War in the Middle East and Amplification Risks. International Monetary Fund; 2026. Available from: \url{https://www.imf.org/en/Publications/GFSR/Issues/2026/04/14/global-financial-stability-report-april-2026}
