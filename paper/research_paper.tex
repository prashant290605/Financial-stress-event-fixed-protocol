...
\title{A Reproducible Event-Fixed Protocol for Evaluating Financial Stress Detectors}
\author{Prashant Singh \and Pranav Singh}
\date{}
...
\noindent\textbf{Keywords:} financial stress detection; event-fixed evaluation; time-series anomaly detection; financial risk monitoring; detection delay; cost-sensitive evaluation.
...
\begin{tabular}{p{0.045\linewidth}p{0.15\linewidth}p{0.085\linewidth}p{0.085\linewidth}p{0.105\linewidth}p{0.34\linewidth}p{0.105\linewidth}}
\toprule
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{timeline_spy.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{multi_asset_tradeoff.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.95\textwidth]{event_level_delay_coverage.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.95\textwidth]{cost_comparison.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{event_window_sensitivity.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{confirmation_window_sensitivity.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{bootstrap_delta.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.95\textwidth]{synthetic_example.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.95\textwidth]{nab_subset_results.pdf}
